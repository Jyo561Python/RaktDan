...
fonts = [
    ...
    {
        "name": "Montserrat",
        "fn_regular": fonts_path + "Montserrat-Regular.ttf",
        "fn_italic": fonts_path + "Montserrat-Regular.ttf",
    },
    {
        "name": "Montserrat-Bold",
        "fn_regular": fonts_path + "Montserrat-Bold.ttf",
        "fn_italic": fonts_path + "Montserrat-Bold.ttf",
    },
    {
        "name": "Icons",
